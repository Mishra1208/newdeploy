        ...
        <main className={`${body.className} ${styles.page}`}>
            ...
            >
                ...
                <div className={`prose ${styles.prose}`}>
                    ...
                    <PolicySection title="5. Browser Extension" icon="🧩">
                        <p>
                            The ConU Planner Ultimate Browser Extension is provided "as is" and "as available". By installing and using the extension, you agree that:
                        </p>
                        <ul className={styles.list}>
                            <li className={styles.listItem}>
                                <span className={styles.itemIcon}>🔹</span> You are solely responsible for ensuring the extension is not used in violation of any university policies.
                            </li>
                            <li className={styles.listItem}>
                                <span className={styles.itemIcon}>🔹</span> The developers are not liable for any data loss, scheduling errors, or system malfunctions that may occur during the use of the extension.
                            </li>
                        </ul>
                    </PolicySection>

                    <PolicySection title="6. Termination" icon="🛑">
                        <p>
