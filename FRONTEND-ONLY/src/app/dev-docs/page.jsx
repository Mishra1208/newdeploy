                        ...
                        <section id="tech-stack" className={activeSection === 'tech-stack' ? 'block' : 'hidden'}>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                ...
                                <div className="space-y-6">
                                    ...
                                    <TechItem name="Supabase" desc="PostgreSQL DB & Email Verification" tag="Database" color="bg-green-700 text-white" />
                                    <TechItem name="Clerk" desc="User Authentication" tag="Auth" color="bg-indigo-600 text-white" />
                                    <TechItem name="Resend" desc="Transactional Emails" tag="Email" color="bg-gray-900 border border-gray-700 dark:bg-black dark:border-white/20 text-white" />
                                </div>
                            </div>
                        </section>
