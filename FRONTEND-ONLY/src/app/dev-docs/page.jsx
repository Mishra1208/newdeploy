                    ...
                    <div className="space-y-20">
                        ...
                        <section id="page-guide" className={activeSection === 'page-guide' ? 'block' : 'hidden'}>
                            ...
                            <div className="grid grid-cols-1 gap-6">
                                ...
                                {/* Seat Finder */}
                                <PageCard
                                    title="Seat Finder & Alerts"
                                    route="/pages/seat-finder"
                                    file="src/app/pages/seat-finder/page.jsx"
                                    desc="Checks if a specific class section is full or open, and allows students to subscribe to email alerts."
                                    coordination="BACKEND: Sends request to Community Server to scrape data. Cron jobs check saved alerts and send Resend emails."
                                />
                        ...
                        <section id="tech-stack" className={activeSection === 'tech-stack' ? 'block' : 'hidden'}>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                ...
                                <div className="space-y-6">
                                    ...
                                    <TechItem name="Resend" desc="Transactional Emails (Seat Alerts)" tag="Email" color="bg-black text-white" />
                                    <TechItem name="Vercel Cron" desc="Automated Background Jobs" tag="Serverless" color="bg-orange-600 text-white" />
                        ...
                        <section id="directory" className={activeSection === 'directory' ? 'block' : 'hidden'}>
                            ...
                            <div className="space-y-4">
                                ...
                                <DirItem path="src/app/api/alerts/cron" desc="Vercel Cron jobs for checking open seats." />
                                ...
                                <DirItem path="src/components/emails" desc="React-Email templates for notifications." />
                            </div>
                        </section>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                                ...
                                <div className="space-y-6">
                                    ...
                                    <div className="space-y-3">
                                        ...
                                        <PkgItem name="resend & @react-email" use="Notifications" desc="Sending beautiful transactional seat alerts." />
