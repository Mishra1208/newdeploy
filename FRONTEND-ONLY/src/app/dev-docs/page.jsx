...
export default function DevDocs() {
    ...
    if (!isAuthenticated) {
        return (
            <div className="fixed inset-0 z-[9999] bg-[#050505] text-white flex items-center justify-center p-4">
                <div className="max-w-md w-full bg-[#0a0a0a] border border-white/10 rounded-2xl p-8 shadow-2xl">
                    <div className="flex flex-col items-center mb-8">
                        <div className="w-16 h-16 bg-purple-900/20 rounded-full flex items-center justify-center mb-4 border border-purple-500/20">
                    ...
                    <form onSubmit={handleLogin} className="space-y-4">
                        ...
                        {error && (
                            <div className="text-red-400 text-xs text-center font-medium bg-red-900/10 py-2 rounded-lg border border-red-500/20">
                                {error}
                            </div>
                        )}
    ...
    return (
        <div className="fixed inset-0 z-[9999] overflow-y-auto bg-[#050505] text-white font-sans selection:bg-purple-500/30">

            {/* Sidebar */}
            <div className="fixed left-0 top-0 bottom-0 w-64 border-r border-white/10 bg-[#0a0a0a] p-6 z-50 flex flex-col">
                <div className="flex items-center gap-3 mb-8">
                    <div className="h-8 w-8 bg-purple-600 rounded-lg flex items-center justify-center font-bold text-lg">CP</div>
                    <span className="font-bold text-lg tracking-tight">Dev Docs</span>
                </div>
                ...
                <nav className="flex flex-col gap-2 flex-1 overflow-y-auto">
                    ...
                    <button
                        ...
                        className="flex items-center gap-3 px-4 py-3 rounded-xl transition-all text-sm font-medium text-red-400 hover:bg-red-500/10 hover:text-red-300"
                    >
                        <Lock size={18} />
                        Logout
                    </button>
                ...
                <div className="mt-4">
                    <div className="p-4 rounded-xl bg-red-900/20 border border-red-500/30 text-xs text-red-200">
                    ...
                    <header className="mb-16">
                        ...
                        <div className="flex flex-wrap gap-4 mb-8">
                            <a href="https://github.com/Mishra1208/newdeploy" target="_blank" rel="noopener noreferrer"
                                className="px-5 py-2.5 rounded-xl bg-white/10 hover:bg-white/20 border border-white/10 text-white font-medium transition flex items-center gap-2">
                            ...
                            <a href="https://vercel.com/dashboard" target="_blank" rel="noopener noreferrer"
                                className="px-5 py-2.5 rounded-xl bg-black hover:bg-gray-900 border border-white/20 text-white font-medium transition flex items-center gap-2">
                    ...
                    <div className="space-y-20">
                        ...
                        <section id="overview" className={activeSection === 'overview' ? 'block' : 'hidden'}>
                            <h2 className="text-3xl font-bold text-white mb-6 flex items-center gap-3">
                                <Globe className="text-purple-500" /> Welcome to the Team{currentUser ? `, ${currentUser}` : ""}
                            </h2>
                            <div className="prose prose-invert max-w-none space-y-6">
                                <p className="text-lg text-gray-300 leading-relaxed">
                                    Hey{currentUser ? ` ${currentUser}` : ""}! 👋 If you're reading this, you probably just joined the project. <strong>Welcome aboard.</strong>
                                </p>
                                <p className="text-gray-300 leading-relaxed">
                                    ...
                                    until it's too late. <strong>We built ConU Planner to fix that.</strong>
                                </p>
                                <p className="text-gray-300 leading-relaxed">
                                    Our mission is simple: <strong>Make academic planning actually feel good.</strong> We want to give students
                                ...
                                <p className="text-gray-300 leading-relaxed">
                                    We aren't just building a utility; we're building a <strong>premium experience</strong>. That's why everything looks sleek,
                                ...
                                <div className="p-6 rounded-2xl bg-white/5 border border-white/10 mt-8">
                                    <h3 className="text-xl font-bold text-white mb-4">How it all works (The "Big Picture")</h3>
                                    <ul className="space-y-4 text-gray-400">
                                        <li className="flex gap-3">
                                            <span className="text-2xl">🎨</span>
                                            <div>
                                                <strong className="text-white">The Frontend (Your main playground)</strong>
                                                <p className="text-sm mt-1">
                                                    Located in <code>FRONTEND-ONLY/src</code>. This is where 90% of the magic happens. It's a <strong>Next.js 15</strong> app.
                                        ...
                                        <li className="flex gap-3">
                                            <span className="text-2xl">🐙</span>
                                            <div>
                                                <strong className="text-white">The "Heavy Lifter" Backend</strong>
                                                <p className="text-sm mt-1">
                                                    Located in <code>conu-community-server</code>. The frontend is pretty, but it can't do everything.
                                ...
                                <div className="p-6 rounded-2xl bg-orange-900/10 border border-orange-500/20 mt-8">
                                    <h3 className="text-xl font-bold text-orange-400 mb-2">🔥 Community Feedback Loop</h3>
                                    <p className="text-gray-400 mb-4">
                                        We don't build in a vacuum. We have an active Reddit thread where students report bugs and request features.
                                        <strong>It is your responsibility to monitor this thread.</strong>
                                    </p>
                                    <a href="https://www.reddit.com/r/Concordia/comments/1qi4ro7/built_a_better_course_planner_for_us_because_the/" target="_blank" rel="noopener noreferrer"
                                        className="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-orange-500/10 hover:bg-orange-500/20 text-orange-400 font-bold transition border border-orange-500/20">
                                        <Globe size={16} />
                        ...
                        <section id="status" className={activeSection === 'status' ? 'block' : 'hidden'}>
                            <h2 className="text-3xl font-bold text-white mb-6 flex items-center gap-3">
                                <Shield className="text-purple-500" /> Status & Roadmap
                            </h2>

                            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                {/* LIVE FEATURES */}
                                <div className="p-8 rounded-3xl bg-green-900/10 border border-green-500/20">
                        ...
                        <section id="features" className={activeSection === 'features' ? 'block' : 'hidden'}>
                            <h2 className="text-3xl font-bold text-white mb-8 flex items-center gap-3">
                                <Star className="text-purple-500" /> Feature Spotlights
                            </h2>

                            <div className="space-y-8">
                                <div className="p-8 rounded-3xl bg-white/5 border border-white/10">
                                    <div className="flex items-center justify-between mb-6">
                                        <h3 className="text-2xl font-bold text-green-400">Planner Export System (Excel)</h3>
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                        <div className="space-y-4">
                                            <div>
                                                ...
                                                <p className="text-gray-300">Students who need a tangible, offline copy of their semester schedules.</p>
                                            </div>
                                            <div>
                                            ...
                                            <div>
                                                ...
                                                <p className="font-mono text-sm text-purple-400">src/lib/exportPlannerExcel.js</p>
                                            </div>
                                        </div>
                                        ...
                                        <div className="space-y-4">
                                            <div>
                                                ...
                                                <ul className="space-y-2 text-sm text-gray-400 list-disc pl-4">
                                                    <li>Fetches a blank template <code>/MyPlannedCourses.xlsx</code> from the public folder.</li>
                                ...
                                <div className="p-8 rounded-3xl bg-white/5 border border-white/10">
                                    <div className="flex items-center justify-between mb-6">
                                        <h3 className="text-2xl font-bold text-orange-400">Inner Circle System (Google Sheets API)</h3>
                                        <div className="px-3 py-1 rounded-full bg-orange-500/20 text-orange-400 text-xs font-bold uppercase">
                                            Server-Side Logic
                                        </div>
                                    </div>
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                        <div className="space-y-4">
                                            <div>
                                                ...
                                                <p className="text-gray-300">Collects emails for the newsletter ("Inner Circle"). Auto-deduplicates entries.</p>
                                            </div>
                                            <div>
                                                <div className="text-xs text-gray-500 uppercase tracking-wider font-bold mb-1">Location</div>
                                                <p className="font-mono text-sm text-purple-400">src/app/api/subscribe/route.js</p>
                                            </div>
                                        </div>
                                        <div className="space-y-4">
                                            <div>
                                                ...
                                                <ul className="space-y-2 text-sm text-gray-400 list-disc pl-4">
                                                    ...
                                                    <li>Request hits Next.js API route <code>/api/subscribe</code>.</li>
                                                    <li>Server authenticates with Google using <strong>Service Account Credentials</strong>.</li>
                                                    <li>Checks for duplicates in the Sheet using <code>googleapis</code>.</li>
                                ...
                                <div className="p-8 rounded-3xl bg-white/5 border border-white/10">
                                    <div className="flex items-center justify-between mb-6">
                                        <h3 className="text-2xl font-bold text-blue-400">Contact & Recruitment Form</h3>
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                        <div className="space-y-4">
                                            <div>
                                                <div className="text-xs text-gray-500 uppercase tracking-wider font-bold mb-1">Purpose</div>
                                                <p className="text-gray-300">Receives applications for developers, designers, and feedback. Bypasses our backend.</p>
                                            </div>
                                            <div>
                                                <div className="text-xs text-gray-500 uppercase tracking-wider font-bold mb-1">Location</div>
                                                <p className="font-mono text-sm text-purple-400">src/app/contact/page.jsx</p>
                                            </div>
                                        </div>
                                        <div className="space-y-4">
                                            <div>
                                                ...
                                                <ul className="space-y-2 text-sm text-gray-400 list-disc pl-4">
                                                    ...
                                                    <li>Submitted via <code>fetch()</code> to a public <a href="https://script.google.com/macros/s/AKfycbyR0Sk7Zo1fIqlUHWztNHKZj-6ywIbBNTh8iCYj1KfYWdavUySG-cOIYvsTvJuQFwPW/exec" target="_blank" className="text-blue-400 underline">Google Apps Script URL</a>.</li>
                                                    <li>Uses <code>mode: 'no-cors'</code> to avoid browser restrictions.</li>
                        ...
                        <section id="tech-stack" className={activeSection === 'tech-stack' ? 'block' : 'hidden'}>
                            <h2 className="text-3xl font-bold text-white mb-8 flex items-center gap-3">
                                <Layers className="text-purple-500" /> Technology Stack
                            </h2>

                            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                {/* Frontend */}
                                <div className="space-y-6">
                                    <h3 className="text-2xl font-semibold text-white/90 border-b border-white/10 pb-2">Frontend Core</h3>
                                    <TechItem name="Next.js 15" desc="React Framework (App Router)" tag="Core" color="bg-white text-black" />
                                    <TechItem name="React 19" desc="UI Library" tag="UI" color="bg-blue-600" />
                                    <TechItem name="TailwindCSS" desc="Utility-first styling" tag="Style" color="bg-cyan-600" />
                                    <TechItem name="Framer Motion" desc="Complex animations & transitions" tag="Animation" color="bg-purple-600" />
                                    <TechItem name="ReactFlow" desc="Interactive prerequisite tree graphs" tag="Viz" color="bg-pink-600" />
                                </div>

                                {/* Backend & Data */}
                                <div className="space-y-6">
                                    <h3 className="text-2xl font-semibold text-white/90 border-b border-white/10 pb-2">Backend & Data</h3>
                                    <TechItem name="Express.js" desc="Community Server API" tag="Server" color="bg-green-600" />
                                    <TechItem name="Puppeteer" desc="Headless browser for scraping" tag="Scraper" color="bg-emerald-600" />
                                    <TechItem name="Supabase" desc="PostgreSQL DB & Email Verification" tag="Database" color="bg-green-700" />
                                    <TechItem name="Clerk" desc="User Authentication" tag="Auth" color="bg-indigo-600" />
                                    <TechItem name="Resend" desc="Transactional Emails" tag="Email" color="bg-black border border-white/20" />
                                </div>
                            </div>
                        </section>
                        ...
                        <section id="env" className={activeSection === 'env' ? 'block' : 'hidden'}>
                            <h2 className="text-3xl font-bold text-white mb-8 flex items-center gap-3">
                                <Settings className="text-purple-500" /> Environment & Configuration
                            </h2>

                            <div className="space-y-8">
                                <div className="p-8 rounded-3xl bg-white/5 border border-white/10">
                                    <h3 className="text-2xl font-bold text-white mb-6">Required Variables (.env.local)</h3>
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        <div className="p-4 rounded-xl bg-black/40 border border-white/5">
                                            <div className="flex items-center justify-between mb-2">
                                                <div className="font-mono text-xs font-bold text-indigo-400">NEXT_PUBLIC_CLERK_PUBLISHABLE_KEY</div>
                                                <div className="px-2 py-0.5 rounded bg-white/10 text-gray-400 text-[10px] uppercase">Public</div>
                                            </div>
                                            <div className="text-sm text-gray-500 mb-2">Public key for Clerk Auth SDK.</div>
                                            <div className="text-xs text-gray-600 bg-white/5 p-2 rounded border border-white/5">
                                                <strong>Where to find:</strong> Clerk Dashboard &gt; API Keys
                                            </div>
                                        </div>
                                        <div className="p-4 rounded-xl bg-black/40 border border-white/5">
                                            <div className="flex items-center justify-between mb-2">
                                                <div className="font-mono text-xs font-bold text-indigo-400">CLERK_SECRET_KEY</div>
                                                <div className="px-2 py-0.5 rounded bg-white/10 text-gray-400 text-[10px] uppercase">Secret</div>
                                            </div>
                                            <div className="text-sm text-gray-500 mb-2">Backend secret key for Clerk.</div>
                                            <div className="text-xs text-gray-600 bg-white/5 p-2 rounded border border-white/5">
                                                <strong>Where to find:</strong> Clerk Dashboard &gt; API Keys
                                            </div>
                                        </div>
                                        <div className="p-4 rounded-xl bg-black/40 border border-white/5">
                                            <div className="flex flex-col gap-2 mb-2">
                                                <span className="font-mono text-xs font-bold text-indigo-400">NEXT_PUBLIC_CLERK_SIGN_IN_URL</span>
                                                <span className="font-mono text-xs font-bold text-indigo-400">NEXT_PUBLIC_CLERK_SIGN_UP_URL</span>
                                                <span className="font-mono text-xs font-bold text-indigo-400">NEXT_PUBLIC_CLERK_AFTER_SIGN_IN_URL</span>
                                                <span className="font-mono text-xs font-bold text-indigo-400">NEXT_PUBLIC_CLERK_AFTER_SIGN_UP_URL</span>
                                            </div>
                                            <div className="text-sm text-gray-500 mb-2">Redirect paths for authentication flows.</div>
                                            <div className="text-xs text-gray-600 bg-white/5 p-2 rounded border border-white/5">
                                        ...
                                        <div className="p-4 rounded-xl bg-black/40 border border-white/5">
                                            <div className="flex items-center justify-between mb-2">
                                                <div className="font-mono text-xs font-bold text-pink-400">GOOGLE_GENERATIVE_AI_API_KEY</div>
                                                <div className="px-2 py-0.5 rounded bg-white/10 text-gray-400 text-[10px] uppercase">Secret</div>
                                            </div>
                                            <div className="text-sm text-gray-500 mb-2">API Key for Gemini Models (AI Chat).</div>
                                            <div className="text-xs text-gray-600 bg-white/5 p-2 rounded border border-white/5">
                                                <strong>Where to find:</strong> <a href="https://aistudio.google.com/" target="_blank" className="underline hover:text-white">Google AI Studio</a> &gt; Get API Key
                                            </div>
                                        </div>
                                        ...
                                        <div className="p-4 rounded-xl bg-black/40 border border-white/5">
                                            <div className="flex items-center justify-between mb-2">
                                                <div className="font-mono text-xs font-bold text-orange-400">GOOGLE_CLIENT_EMAIL</div>
                                                <div className="px-2 py-0.5 rounded bg-white/10 text-gray-400 text-[10px] uppercase">Secret</div>
                                            </div>
                                            <div className="text-sm text-gray-500 mb-2">Service Account Email for accessing Google Sheets (Inner Circle).</div>
                                            <div className="text-xs text-gray-600 bg-white/5 p-2 rounded border border-white/5">
                                        ...
                                        <div className="p-4 rounded-xl bg-black/40 border border-white/5">
                                            <div className="flex items-center justify-between mb-2">
                                                <div className="font-mono text-xs font-bold text-orange-400">GOOGLE_PRIVATE_KEY</div>
                                                <div className="px-2 py-0.5 rounded bg-white/10 text-gray-400 text-[10px] uppercase">Secret</div>
                                            </div>
                                            <div className="text-sm text-gray-500 mb-2">Service Account Private Key. (Must replace `\n` in Vercel).</div>
                                            <div className="text-xs text-gray-600 bg-white/5 p-2 rounded border border-white/5">
                                        ...
                                        <div className="p-4 rounded-xl bg-black/40 border border-white/5">
                                            <div className="flex items-center justify-between mb-2">
                                                <div className="font-mono text-xs font-bold text-blue-400">GOOGLE_SHEET_ID</div>
                                                <div className="px-2 py-0.5 rounded bg-white/10 text-gray-400 text-[10px] uppercase">Config</div>
                                            </div>
                                            <div className="text-sm text-gray-500 mb-2">The ID of the `ConU Planner - Early Access` Google Sheet.</div>
                                            <div className="text-xs text-gray-600 bg-white/5 p-2 rounded border border-white/5">
                                                <strong>Where to find:</strong> The string between <code>/d/</code> and <code>/edit</code> in the Sheet URL.
                                            </div>
                                        </div>
                                        ...
                                        <div className="p-4 rounded-xl bg-black/40 border border-white/5">
                                            <div className="flex items-center justify-between mb-2">
                                                <div className="font-mono text-xs font-bold text-green-400">COMMUNITY_API_URL</div>
                                                <div className="px-2 py-0.5 rounded bg-white/10 text-gray-400 text-[10px] uppercase">Config</div>
                                            </div>
                                            <div className="text-sm text-gray-500 mb-2">URL of the backend server. Defaults to `http://localhost:4000`.</div>
                                            <div className="text-xs text-gray-600 bg-white/5 p-2 rounded border border-white/5">
                                        ...
                                        <div className="mt-4 pt-4 border-t border-white/10 text-xs text-gray-500">
                                            <strong className="text-purple-400">Storage Location:</strong>
                                            <ul className="list-disc pl-4 mt-1 space-y-1">
                                                <li><strong>Local:</strong> Create a <code>.env.local</code> file in `FRONTEND-ONLY/`.</li>
                        ...
                        <section id="component-map" className={activeSection === 'component-map' ? 'block' : 'hidden'}>
                            <h2 className="text-3xl font-bold text-white mb-6 flex items-center gap-3">
                                <Database className="text-purple-500" /> Component Coordination Map
                            </h2>
                            <p className="text-gray-400 mb-8 max-w-3xl">
                            ...
                            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                                <div className="p-6 bg-white/5 rounded-2xl border border-white/10">
                                    <h3 className="text-xl font-bold text-pink-400 mb-4">Core Flow</h3>
                                    <ul className="space-y-4 text-gray-300 text-sm">
                                        <li className="flex gap-3">
                                            <div className="w-6 h-6 rounded-full bg-pink-900/50 flex items-center justify-center text-pink-400 font-bold text-xs">1</div>
                                        ...
                                        <li className="flex gap-3">
                                            <div className="w-6 h-6 rounded-full bg-pink-900/50 flex items-center justify-center text-pink-400 font-bold text-xs">2</div>
                                            <div><strong>Pages (page.jsx)</strong> are injected inside the layout. Each folder in <code>app/</code> represents a route.</div>
                                        </li>
                                        <li className="flex gap-3">
                                            <div className="w-6 h-6 rounded-full bg-pink-900/50 flex items-center justify-center text-pink-400 font-bold text-xs">3</div>
                                            <div><strong>ChatWidget</strong> is unique. It floats independently and calls <code>/api/smart-chat</code> to get answers.</div>
                                        </li>
                                    </ul>
                                </div>

                                <div className="p-6 bg-white/5 rounded-2xl border border-white/10 flex items-center justify-center bg-white/5">
                                    <img
                                        src="/Devdocs dig.svg"
                        ...
                        <section id="directory" className={activeSection === 'directory' ? 'block' : 'hidden'}>
                            <h2 className="text-3xl font-bold text-white mb-6 flex items-center gap-3">
                                <Folder className="text-purple-500" /> Key Directories
                            </h2>
                            <p className="text-gray-400 mb-6">
                        ...
                        <section id="commands" className={activeSection === 'commands' ? 'block' : 'hidden'}>
                            <h2 className="text-3xl font-bold text-white mb-6 flex items-center gap-3">
                                <Terminal className="text-purple-500" /> Commands & Installation
                            </h2>

                            {/* Quick Start Guide */}
                            <div className="mb-12 p-6 rounded-2xl bg-gradient-to-r from-purple-900/20 to-blue-900/20 border border-purple-500/20">
                                ...
                                <div className="space-y-6">
                                    <div>
                                        ...
                                        <div className="bg-black/50 p-4 rounded-lg border border-white/5 font-mono text-sm text-gray-300">
                                            <div className="flex gap-2"><span className="text-purple-400">$</span> cd FRONTEND-ONLY</div>
                                            <div className="flex gap-2"><span className="text-purple-400">$</span> npm install</div>
                                            <div className="flex gap-2"><span className="text-purple-400">$</span> npm run dev</div>
                                        </div>
                                        <p className="text-xs text-gray-500 mt-2">Runs on <span className="text-white">localhost:3000</span>.</p>
                                    </div>
                                    <div>
                                        <div className="text-xs uppercase font-bold text-gray-500 mb-2">2. Backend Setup (Express Microservice)</div>
                                        <div className="bg-black/50 p-4 rounded-lg border border-white/5 font-mono text-sm text-gray-300">
                                            <div className="flex gap-2"><span className="text-purple-400">$</span> cd FRONTEND-ONLY/conu-community-server</div>
                                            <div className="flex gap-2"><span className="text-purple-400">$</span> npm install</div>
                                            <div className="flex gap-2"><span className="text-purple-400">$</span> node server.js</div>
                                        </div>
                                        <p className="text-xs text-gray-500 mt-2">Runs on <span className="text-white">localhost:4000</span>.</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                                {/* Commands */}
                                <div className="space-y-6">
                                    <h3 className="text-xl font-bold text-green-400 border-b border-green-500/30 pb-2">Common Commands</h3>
                                ...
                                {/* Packages */}
                                <div className="space-y-6">
                                    <h3 className="text-xl font-bold text-orange-400 border-b border-orange-500/30 pb-2">Key Packages</h3>
...
function DirItem({ path, desc }) {
    return (
        <div className="flex gap-4 p-4 bg-[#111] rounded-lg border-l-4 border-purple-600">
            <div className="font-mono text-purple-300 font-bold shrink-0">{path}</div>
...
function CmdItem({ cmd, desc }) {
    return (
        <div className="group relative">
            <div className="bg-[#0f0f0f] border border-white/10 rounded-lg p-5 font-mono text-sm text-green-400 shadow-lg">
                <span className="select-none text-gray-600 mr-3">$</span>
                {cmd}
            </div>
            <div className="mt-2 text-gray-500 text-xs ml-4">{desc}</div>
        </div>
    )
}
        ...
        <div className="bg-white/5 border border-white/10 rounded-xl p-6 hover:bg-white/10 transition-colors">
            <div className="flex items-start justify-between mb-4">
                <div>
                    ...
                    <div className="flex items-center gap-3 text-sm font-mono">
                        <span className={`px-2 py-0.5 rounded ${isApi ? 'bg-yellow-900/30 text-yellow-500' : 'bg-green-900/30 text-green-400'}`}>
                            {route}
                        </span>
            ...
            <div className="space-y-3">
                ...
                <div className="pt-3 border-t border-white/5">
                    <div className="text-xs font-bold text-purple-400 mb-1 uppercase tracking-wider">Coordination & Data</div>
        ...
        <div className="flex items-start justify-between p-4 bg-white/5 rounded-xl border border-white/5 hover:border-white/10 transition-colors">
            <div className="flex-1 mr-4">
                <div className="flex items-center gap-2 mb-1">
                    <div className="font-bold text-base text-gray-200">{name}</div>
                    <div className="px-2 py-0.5 rounded-full bg-orange-900/30 text-orange-400 text-[10px] font-bold uppercase tracking-wide">
                        {use}
                    </div>
                </div>
    ...
    return (
        <li className="flex items-center gap-3 text-gray-300">
            {active ? (
                ...
                <div className="w-5 h-5 rounded-full bg-white/5 border border-dashed border-white/20 text-transparent">
                    .
                </div>
            )}
            <span className={highlight ? "text-purple-300 font-bold" : ""}>
                {text}
            </span>
            {highlight && (
                <span className="text-[10px] font-bold px-2 py-0.5 rounded bg-purple-500/30 text-purple-300 uppercase tracking-wider">
                    Next
                </span>
            )}
        </li>
