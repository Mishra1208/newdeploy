...
import { Mail, Sparkles, Instagram, CheckCircle } from "lucide-react";
        ...
        <div className={styles.brandCol}>
          ...
          <div className={styles.socials}>
            ...
            <div className={styles.tooltipWrapper}>
              ...
              <span className={styles.tooltipText}>Only visible to authorized members</span>
            </div>
            ...
            <div className={styles.tooltipWrapper}>
              <button
                ...
                className={`${styles.socialIcon} ${styles.emailButton} ${copied ? styles.copiedState : ''}`}
