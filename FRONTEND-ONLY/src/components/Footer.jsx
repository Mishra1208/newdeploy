...
export default function Footer() {
  ...
  const handleCopyEmail = (e) => {
    e.preventDefault();
    navigator.clipboard.writeText("contact.conuplanner@gmail.com");
    setCopied(true);
        ...
        <div className={styles.brandCol}>
          ...
          <div className={styles.socials}>
            <div className={styles.githubWrapper}>
              <a href="https://github.com/Mishra1208/newdeploy" target="_blank" rel="noopener noreferrer" className={`${styles.socialIcon} ${styles.githubIcon}`} aria-label="Github">
              ...
              <span className={styles.githubTooltip}>Only visible to authorized members of the project</span>
            </div>
            <a href="https://www.instagram.com/conuplanner/" target="_blank" rel="noopener noreferrer" className={`${styles.socialIcon} ${styles.instagramIcon}`} aria-label="Instagram">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="2" width="20" height="20" rx="5" ry="5"></rect><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"></path><line x1="17.5" y1="6.5" x2="17.51" y2="6.5"></line></svg>
            </a>
            <button 
              onClick={handleCopyEmail} 
              className={`${styles.socialIcon} ${styles.emailCopyBtn} ${copied ? styles.copied : ""}`}
              aria-label="Copy Email"
              title="Copy Email"
            >
              <div className={styles.emailIconWrapper}>
                {copied ? (
                  <svg className={styles.checkIcon} width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polyline points="20 6 9 17 4 12"></polyline></svg>
                ) : (
                  <svg className={styles.mailIcon} width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"></path><polyline points="22,6 12,13 2,6"></polyline></svg>
                )}
              </div>
              <span className={styles.copyTooltip}>{copied ? "Email Copied!" : "Copy Email"}</span>
            </button>
          </div>
        </div>
          ...
          <ul className={styles.linkList}>
            ...
            <li>
              <button
                ...
                className={`${styles.link} ${styles.linkResource}`}
