...
import { motion, AnimatePresence } from "motion/react"; // needs `motion` package
...
const RotatingText = forwardRef(function RotatingText(
  ...
  return (
    <motion.span className={cx("text-rotate", mainClassName)} {...rest} layout transition={transition}>
